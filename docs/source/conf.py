...
project = "Architecture-as-Code Gen-Gherkin Plugin"
copyright = f"2021 - {str(date.today().year)} , AaC Gen-Gherkin Project Contributors"
author = "AaC Gen-Gherkin Project Contributors"

# The full version, including alpha/beta/rc tags
release = metadata.version("aac-gen-gherkin")
